...
<div class="Elastic">
      ...
      <el-dialog title="" :visible.sync="dialogFormVisible" align="middle" type="flex">
         <el-divider>添加客户</el-divider>
          ...
          <br><span style="margin-left:70px;">标签 : </span><el-select v-model="value" clearable placeholder="" style="margin-top:20px;">
    <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option></el-select>
          
           <br><span style="margin-left:-40px;">性别 : </span><el-radio-group v-model="radio1" style="margin-top:20px;">
                                 <el-radio :label="3">男</el-radio>
                                 <el-radio :label="6">女</el-radio>
                           </el-radio-group>


           <br><div class="block" style="margin-left:70px;">
                       <span class="demonstration">生日 : </span>
                       <el-date-picker v-model="value" type="date" placeholder="选择日期" style="margin-top:20px;"></el-date-picker>
               </div>

           <span style="margin-left:68px;">地域 : </span><el-select v-model="value" clearable placeholder="" style="margin-top:20px;">
               <el-option v-for="item in options1" :key="item.value" :label="item.label" :value="item.value"></el-option></el-select>

           <br><span style="margin-left:52px;">备注 : </span><el-input type="textarea" :rows="2" placeholder="请不要超过200字" v-model="textarea" style="width:200px;margin-top:20px;"></el-input>
